...
```
## html leaflet map screenshots
![Leaflet Map (screenshot)](Leaflet-Map-list-json.png)

---

![Leaflet Map - open (screenshot](Leaflet-Map-list-json-open.png)

# Images of leaflet map webpage
## read png image
```{r include-graphics-img2}
