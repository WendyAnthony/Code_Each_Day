---
title: "Interactive Geography Course Planning Tools ...Student Feedback? ![](images/Dynamic-edge-transparent.png){width=85% height=50}" 
...
# Feedback Requests | for consideration ...
* Usefulness? Functionality?
* Formatting Design
* Title / Tab Names
* Suggestions ... What to keep / change / add?
...
# Visualizing Geog Courses | Experiments ...
* Animated Word Cloud  
...
## Animated Word Cloud of Course Desc
...
gc_group_bar_sub <- ggplot(gc_group_sub, 
  ...
  labs(title = "UVic Geography Course ClassSize",
...
![](https://raw.githubusercontent.com/WendyAnthony/Code_Each_Day/master/My_Code/GeogInteractive/Shiny%20Gantt%20Chart%20Interactive/ShinyMermaidFlowChartInteractive/Mermaid-chart-2023-03-03-ss.png){height=400}

![](https://raw.githubusercontent.com/WendyAnthony/Code_Each_Day/master/My_Code/GeogInteractive/Shiny%20Gantt%20Chart%20Interactive/ShinyMermaidFlowChartInteractive/Mermaid-code-2023-03-03-ss.png){height=400}
...
![](https://raw.githubusercontent.com/WendyAnthony/Code_Each_Day/master/My_Code/GeogInteractive/Shiny%20Gantt%20Chart%20Interactive/Gantt-chart-ss-2023-02-03.png){width=500}
![](https://raw.githubusercontent.com/WendyAnthony/Code_Each_Day/master/My_Code/GeogInteractive/Shiny%20Gantt%20Chart%20Interactive/Gantt-code-ss-2023-02-03.png){width=200}
...
* **Interactive [Leaflet Map](#leaflet-map)** with markers for UVic, Field Studies, Natural Areas
...
* **Hyperlinks to course catalogue** 
    * from Data Table and/or [Mermaid Course Flowchart diagram](https://people.geog.uvic.ca/wanthony/website/geog-curriculum-maps/images/mermaid-1-ss.pdf)
* **Anything else?**
...
* Adding Course Catalog links to Data Table
* Stay in same tab after using Browser Back Button
...
* **Student feedback** / input? e.g. SOGS, Community Mapping
