...
![](Dataviz/Geog-Course-Desc-Wordcloud-images23-delay60-loop1-ezgif.com.png)
...
![](Dataviz/mermaid-1-ss.pdf){height=800 width=100%}

![](images/mermaid-code-ss.png)
...
* **Note**: This chart is interactive ... some missing info (summer classes?)
...
* **Interactive Leaflet Map**: add markers for Field Schools, UVic Buildings, UVic Natural Area Locations, Community Mapping Partners
...
* **Network flow chart** to highlight pathways between associated courses, to replace copyright Interactive Pathway code
* use **hyperlinks to course catalogue** from data table
...
## Telus
* Used 90% of monthly data since January 11  
