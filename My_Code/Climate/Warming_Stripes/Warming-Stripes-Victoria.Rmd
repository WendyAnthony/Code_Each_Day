...
# Create the Stripes
## Theme Create default theme_minimal() style 
...
stplt_lg <- ggplot(groupby_temp_victoria,
        ...
        geom_tile() +
           ...
           scale_fill_gradientn(colors = rev(col_strip)) +
            ...
            labs(title = "Victoria BC Intl. Airport Average Yearly Mean °C Temperature 1941-2021",
...
## create anomaly plot with no legend
...
```{r create_image_files_legend_anomaly}
# png files have very poor resolution >>> add res = 300
png("VictoriaClimateStripes-1941-2021-nolg-anom.png", units="in", width=6, height=5, res = 300)
stplt_nolg_anom
dev.off()
