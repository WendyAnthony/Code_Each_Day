...
# Function census_age_gender_ggplot and save all in one
```{r function_ggplot_save, class.output="scroll-100"}
...
```{r function_ggplot, class.output="scroll-100"}
...
```{r function_save_ggplot, class.output="scroll-100"}
...
## Plot and save file Using separate save function
```{r plot-function-save-file-sep, class.output="scroll-100"}
