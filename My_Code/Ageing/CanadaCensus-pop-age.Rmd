...
BC <- BC_pop_2021 %>%
  ...
  scale_fill_manual(values = colour_palette) +
  labs(title = "British Columbia Population \n by Age & Gender",
       subtitle = "(2021 Canada Census)",
       x = "Age Group",
       y = "Population",
       caption = "Data: https://www12.statcan.gc.ca/census-recensement/2021") 

BC + scale_y_continuous(limits = c(0, 400000), labels = scales::comma) 
...
BC_lab + scale_y_continuous(limits = c(0, 400000), labels = scales::comma) 
```
