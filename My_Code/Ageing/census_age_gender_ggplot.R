census_age_gender_ggplot <- function(data, colpat1, colpat2, title, subtitle, caption, labelsize, filename = NULL, aspect_ratio = 2.5){
  ...
  # format pop with commas in thousands
#  formatC(data$pop, format = "d", big.mark = ",")
