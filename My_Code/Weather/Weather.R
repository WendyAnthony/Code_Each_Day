...
############################### =================================S
# available data stations, years & intervals
...
############################### =================================
# ggplot2 temperature
class(vic_UVic$temp_dew)
str(vic_UVic)
summary(vic_UVic)
vic_UVic <- vic_UVic[!is.na(vic_UVic$temp),]

# https://rstudio-pubs-static.s3.amazonaws.com/441097_0a838e64ad0f4550ba50f1884541f95e.html

# Time Series -----------------------------------------------------
ggplot(data = vic_UVic, aes(x = time, y = temp)) + 
  geom_line()

# Scatter Plot of NASA storm type ----------------------------------
...
# Scatterplot with facet  lat/lng of storms per year -------------------------
