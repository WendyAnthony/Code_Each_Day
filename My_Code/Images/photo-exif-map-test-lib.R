...
# shift+control+h
getwd()
# be sure to add trailing / at end of dir/
#  /Volumes/My Passport for Mac/Pictures/!!Nikon-Camera/Nikon-Coolpix-GPS/2021-06-15-ChownGarden-JasmineFlowers-HarrietGorgePark-HarlingPoint-UplandsPark/
...
m <- leaflet(dat2) %>%
  ...
  addMarkers(~ GPSLongitude, ~ GPSLatitude,
             popup = paste0("<img src = '/Volumes/My Passport for Mac/Pictures/!!Nikon-Camera/Nikon-Coolpix-GPS/2021-06-15-ChownGarden-JasmineFlowers-HarrietGorgePark-HarlingPoint-UplandsPark/", dat2$SourceFile, "' style='width:314px;height:239px;'", ">"))
# be sure to use trailing / for directory/
...
m3 <- leaflet(dat2) %>%
  ...
  addMarkers(clusterOption = markerClusterOptions(spiderfyOnMaxZoom = TRUE),
             ...
             popup = paste0("<b>ImageName:</b> ", dat2$SourceFile, "<br>", "<b>Image Date:</b> ", dat2$DateTimeOriginal, "<br><br>",
                            "<img src = '/Volumes/My Passport for Mac/Pictures/!!Nikon-Camera/Nikon-Coolpix-GPS/2021-06-15-ChownGarden-JasmineFlowers-HarrietGorgePark-HarlingPoint-UplandsPark/",
                            dat2$SourceFile, "' style='width:314px;height:239px;'", ">"))
m3$width <- 1000
m3$height <- 1000

saveas(m3, "photo-map-pop-4.html")
############################
############################
