...
# "    "     >> Shiny publish
# >>> add casual/needs ID >> works @19:30
# add ARME project >> project doesn't include imageurl??
# Add Download Button
...
#############################################
  ...
  ui <- fluidPage(
    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Research-Grade", leafletOutput("mymap_r_n_3")),
  ...
  server <- function(input, output, session) {
    ...
    ## download button not showing once published?
    ## https://shiny.rstudio.com/reference/shiny/1.6.0/downloadHandler.html
  }
