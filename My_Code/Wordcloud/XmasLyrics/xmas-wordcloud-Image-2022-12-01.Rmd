...
# use output: bookdown::html_document2 to get numbered figure captions
```
...
# Chants de Noël nuage de mots

## 15 Chants de Noël Titres pour les paroles
```{r french-titles, class.output="scroll-100", echo=FALSE}
xmas_titles_french_df
```

## Interactif nuage de mots en français
*(Planer par-dessus les mots pour fréquence)*
...
### L’étoile en noire
```{r, echo=FALSE, fig.cap="L’étoile en noire"}
...
### L’étoile en or
```{r, echo=FALSE, fig.cap="L’étoile en or"}
...
### Couleur en fréquence
#### rouge, vert, gris
```{r, echo=FALSE, fig.cap="Couleur en fréquence: rouge, vert, gris"}
...
#### rouge, vert
```{r, echo=FALSE, fig.cap="Couleur en fréquence: rouge, vert"}
...
#### rouge, vert, violet
```{r, echo=FALSE, fig.cap="Couleur en fréquence: rouge, vert, violet"}
...
```{r, echo=FALSE, fig.cap="Couleur en fréquence: rouge, vert, violet, gris"}
...
#### rouge, vert, gris - fréquence >2
```{r, echo=FALSE, fig.cap="Couleur en fréquence: rouge, vert, gris - fréquence >2"}
...
#### rouge, vert - fréquence >2
```{r, echo=FALSE, fig.cap="Couleur en fréquence: rouge, vert - fréquence >2"}
