...
1. In RStudio console window type the following commands one-at-a-time, followed by the <enter> key (the > prompt will appear when process is complete):  
...
# Use Wordcloud app
## Open 3 RShiny app files in RStudio:   
* global.R   
* ui.R  
* server.R  

```{r open-files, echo=FALSE, fig.cap="Image Caption: Open files", out.width = '50%'}
knitr::include_graphics("2-open-file.png")
```
 
---

```{r opened-files, echo=FALSE, fig.cap="Image Caption: Opened files", out.width = '50%'}
...
```{r run-app-botton, echo=FALSE, fig.cap="Image Caption: Click Run App button", out.width = '50%'}
knitr::include_graphics("4.1-run-app.png")
```

* Running app shows 'Processing corpus' at bottom of screen   
```{r run-app, echo=FALSE, fig.cap="Image Caption: Run app", out.width = '50%'}
...
```{r run-processing, echo=FALSE, fig.cap="Image Caption: Processing messages in console window", out.width = '50%'}
...
```{r waiting-wordcloud-2, echo=FALSE, fig.cap="Image Caption: Finished Wordcloud", out.width = '50%'}
...
```{r finished-wordcloud-2, echo=FALSE, fig.cap="Image Caption: Finished Wordcloud", out.width = '50%'}
...
```{r waiting-max-word-count, echo=FALSE, fig.cap="Image Caption: Waiting for maximum word count", out.width = '50%'}
...
### Maximum words 7000
```{r max-words-7000, echo=FALSE, fig.cap="Image Caption: Maximum words 7000", out.width = '50%'}
...
```{r max-words-235, echo=FALSE, fig.cap="Image Caption: Maximum words 235", out.width = '50%'}
...
```{r choose-text, echo=FALSE, fig.cap="Image Caption: Choose a different text", out.width = '50%'}
...
```{r change-text, echo=FALSE, fig.cap="Image Caption: 'Change text button'", out.width = '50%'}
...
```{r open-in-browser, echo=FALSE, fig.cap="Image Caption: Open Shiny app in browser", out.width = '50%'}
...
```{r save-image-1, echo=FALSE, fig.cap="Image Caption: Right-click to save image to computer", out.width = '50%'}
knitr::include_graphics("15.1-save-image-1.png")
```
 
---

```{r save-image-2, echo=FALSE, fig.cap="Image Caption: Save image to computer", out.width = '50%'}
knitr::include_graphics("15.2-save-image-2.png")
```
 
---

```{r save-image-3, echo=FALSE, fig.cap="Image Caption: Rename image file", out.width = '50%'}
...
```{r change-sliders, echo=FALSE, fig.cap="Image Caption: Change Sliders", out.width = '50%'}
...
```{r add-new-text, echo=FALSE, fig.cap="Image Caption: Add new text files", out.width = '50%'}
...
```{r stop-words, echo=FALSE, fig.cap="Image Caption: List of words to exclude", out.width = '50%'}
...
```{r change-default, echo=FALSE, fig.cap="Image Caption: Changing default values", out.width = '50%'}
